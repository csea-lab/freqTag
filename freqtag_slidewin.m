...
% ssVEP signal-to-noise ratio in decibels at the frequency of interest for each trial (trialamp) 
 ...
 win_wlf = 4; % this is the window length factor as a multiple of cycle; ssVEP: win_wlf = 4 cycles; assr: win_wlf = 8 cycles;
 winshiftvec = winshiftvec_long(1:endindex-(win_wlf + 1);

 % need this stuff for the spectrum
 shiftcycle=round(tempvec*win_wlf); % this isn't hardcoded anymore; set win_wlf to 4 for ssVEP or 8 for higher frequencies such as assr
 samp=1000/sampnew;
