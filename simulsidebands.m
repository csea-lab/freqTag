...
xlabel(['SNR at tag 2 (' num2str(freq2) 'Hz)']), ylabel(['Amplitude for tag 1 (' num2str(freq1) 'Hz)']),
title('Tag 1 amplitude by Tag 2 SNR') 
subplot(1,2,2), plot(origSNR1, squeeze(mean(trialmagf2,3))), legend(num2str(origSNR2'))
xlabel(['SNR at tag 1 (' num2str(freq1) 'Hz)']), ylabel(['Amplitude for tag 2 (' num2str(freq2) 'Hz)'])
title('Tag 2 amplitude by Tag 1 SNR') 
